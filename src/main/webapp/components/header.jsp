...
<style>
  ...
  <header x-data="{ isOpen: false }" class="relative bg-red shadow">
      ...
      <div class="flex flex-col md:flex-row md:justify-between md:items-center">
        ...
        <div class="md:flex items-center" :class="isOpen ? 'block' : 'hidden'">
          ...
          <div class="flex items-center py-2 -mx-1 md:mx-0">
            ...
            <a class="block w-1/2 px-3 py-2 mx-1 rounded text-center text-sm bg-blue-500 font-medium text-white leading-5 hover:bg-blue-600 md:mx-0 md:w-auto" href="/signup">SignU</a>
          </div>
