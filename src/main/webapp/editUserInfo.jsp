...
<body class="bg-[#4a76a8]">
    ...
    <form method="post" action="editUserInfo/${userSession.getUserID()}">
                            ...
                            <div class="account-settings">
                                <div class="user-profile">
                                    <div class="user-avatar ">
                                        <img src="https://www.kindpng.com/picc/m/495-4952535_create-digital-profile-icon-blue-user-profile-icon.png" alt="Maxwell Admin">
                                    </div>
