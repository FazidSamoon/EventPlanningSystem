...
<html>
    ...
    <body class="overflow-x-hidden">
        ...
        <!-- component -->
<%--        <div class="-my-2 py-2 overflow-x-hidden sm:-mx-6 sm:px-6 lg:-mx-8 pr-10 lg:px-8">--%>
...
<%--            </div>--%>
            ...
            <div class="align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard px-8 pt-3 rounded-bl-lg rounded-br-lg">
                <table class="min-w-full">
                    ...
                    %>
                        <div>
                            <h1>hello ${service.getServiceName()}</h1>
                            <h1>hello ${service.getServicePrice()}</h1>
                            <h1>hello ${service.getServiceDescription()}</h1>
                            <h1>hello ${service.getServiceId()}</h1>
                        </div>
...
<%--    %>--%>
                    ...
                    <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500 text-blue-900 text-sm leading-5"></td>
